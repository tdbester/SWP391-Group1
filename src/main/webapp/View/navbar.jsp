...
<div class="dashboard">
    ...
    <div class="sidebar">
        ...
        <nav>
            ...
            <div class="nav-section">
                <a href="TeachingSchedule.jsp" class="nav-item ${pageContext.request.requestURI.contains('TeachingSchedule.jsp') ? 'active' : ''}" role="link" aria-current="${pageContext.request.requestURI.contains('TeachingSchedule.jsp') ? 'page' : 'false'}">
            ...
            <div class="nav-section">
                <a href="JobList.jsp" class="nav-item ${pageContext.request.requestURI.contains('JobList.jsp') ? 'active' : ''}" role="link" aria-current="${pageContext.request.requestURI.contains('JobList.jsp') ? 'page' : 'false'}">
                    ...
                    <div class="nav-section">
                <a href="JobDetails.jsp" class="nav-item ${pageContext.request.requestURI.contains('JobDetails.jsp') ? 'active' : ''}" role="link" aria-current="${pageContext.request.requestURI.contains('JobDetails.jsp') ? 'page' : 'false'}">
                    <i class="fas fa-info-circle" aria-hidden="true"></i>
                    <span>Phân công dạy thay</span>
                </a>
                    </div>
                    <div class="nav-section">
                <a href="Applications.jsp" class="nav-item ${pageContext.request.requestURI.contains('Applications.jsp') ? 'active' : ''}" role="link" aria-current="${pageContext.request.requestURI.contains('Applications.jsp') ? 'page' : 'false'}">
